...
<div class="verify-container">
    ...
    <form action="index.php" method="post">
        ...
        <input type="number" id="code" name="verify_code_number" placeholder="Enter code" required>
        <input type="submit" value="Verify Code">
    </form>
</div>
<?php if(isset($error) && $error):?>
<div class="error-message" style="display:block" id="error">Incorrect code entered</div>
<?php endif; ?>
</body>
</html>
