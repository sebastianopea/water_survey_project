...
<div id="success-alert" role="alert" class="rounded-lg border border-gray-100 bg-white p-2 max-w-xs mx-auto">
    <div class="flex items-start gap-2">
        ...
        <div class="flex-1">
            <strong class="block font-medium text-gray-900">Password Reset Successfully</strong>
        </div>
...
<div class="error-message" style="display:block" id="error">Incorrect credentials, please try again</div>
<?php endif; ?>
